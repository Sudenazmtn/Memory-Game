...
public abstract class WordBaseController extends AbstractLevelController {
    protected int rows, cols, showTimeMs;
    protected Map<String, String> wordPairs = new HashMap<>();
    ...
    public WordBaseController(ScoreManager s, TimeManager t, int rows, int cols, int showTimeMs, Runnable onComplete) {
    ...
    public JPanel startLevel() {
        ...
        for (String w : words) {
            TileData data = new TileData(w, null, w);
    ...
    private void checkMatch() {
        javax.swing.Timer t = new javax.swing.Timer(500, e -> {
            if (firstSelected != null && secondSelected != null) {
                String w1 = firstSelected.getData().getMatchValue();
                String w2 = secondSelected.getData().getMatchValue();

                boolean isMatch = (wordPairs.containsKey(w1) && wordPairs.get(w1).equals(w2)) ||
                        (wordPairs.containsKey(w2) && wordPairs.get(w2).equals(w1));
